    ...
    match method {
        ...
        "navigate" => {
            ...
            let phase1 = vec![
                ...
                CdpEvent {
                    method: "Runtime.executionContextCreated".into(),
                    params: json!({"context": {"id": 100, "origin": page_url, "name": "__puppeteer_utility_world__24.40.0", "uniqueId": format!("ctx-isolated-nav-{}", page_id), "auxData": {"isDefault": false, "type": "isolated", "frameId": frame_id}}}),
                    session_id: es.clone(),
                },
                CdpEvent {
                    method: "Page.lifecycleEvent".into(),
